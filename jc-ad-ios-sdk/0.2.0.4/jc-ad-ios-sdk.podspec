...
Ad Combination SDK for iOS. Apis are inherited from Mopub ios sdk with JC Prefix.
  ...
  s.subspec "Core" do |ss|
      ...
      ss.source_files = "jc-ad-ios-sdk/Sources/**/*.{h,m,mm,c,swift}"
      ...
      ss.dependency 'Google-Mobile-Ads-SDK', '11.0.1'
      ss.dependency 'UnityAds', '4.12.5'
      ss.dependency 'Protobuf'
      ss.dependency 'GoogleUserMessagingPlatform', '2.7.0'
